...
class TestHttpClient:
    def test_init(self):
        ...
        client = HttpClient()
        assert client._timeout == (settings.check_timeout_connect, settings.check_timeout_read)
        client.close()
...
class TestEvents:
    ...
    def test_event_values_are_strings(self):
        assert isinstance(Events.CHECK_STARTED, str)
        assert isinstance(Events.CHANNEL_CHECKED, str)
        assert Events.CHECK_STARTED == "check:started"
